...
- Yürüyüş ve Hareket Kuralları: Modelin yürüme açısını ve kameranın çekim açısını her analizde tekdüze (sadece karşıdan) yapma, çeşitlendir:
  * Bazen model çapraz bir açıyla (3/4 açıyla) yürümeli ve kameraya doğru yaklaşmalı (çapraz/açılı yürüyüş).
  * Bazen model yan profilden yürümeli ve kamera onu takip etmeli (profilden yürüyüş ve kamera takibi).
  * Bazen model düz karşıya yürümeli, ardından yavaşça durup omuz üstü bir dönüşle kıyafeti sergilemeli.
  * Kameranın hareketini de çeşitlendir: Yavaşça yaklaşma (slow zoom-in), modelle birlikte yana kayma çekimi (tracking shot), hafif yukarıdan aşağı süzme çekimi (jib shot) veya yavaşça dönen kamera (orbital pan).
  * Yürürken kıyafetin salınımını (örn: eteğin hafifçe uçuşması, ceket ve kollardaki doğal hareketler) ve ellerinin zarif hareketlerini detaylıca betimle. promptSuggestion Türkçe, kıyafeti, ortamı, kombini ve hareketi birleştiren doğal, akıcı ve profesyonel bir video tanıtım promptu olmalıdır. Kumaşın kalın, tok ve opak olduğunu da metin içinde belirt.
