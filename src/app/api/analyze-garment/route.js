...
- Ürün Odaklı 3D Ortam Önerisi Kuralı: Eğer görselde bir insan/manken bulunmuyorsa ve sadece arka plansız/tekil bir ürün fotoğrafı (askıda, flat-lay veya hayalet manken) yüklenmişse; kıyafetin tarzına, mevsimine ve tipine en uygun 3 boyutlu (3D) gerçekçi bir ortam belirle (örneğin kalın bir kışlık mont için kar yağışlı şık bir kış caddesi, gelinlik için görkemli ve şık bir katedral/saray koridoru, yazlık bluz için güneşli bir sahil yolu veya modern açık hava kafesi). Bu ortamı promptSuggestion içerisinde düz bir "arka plan görseli" gibi değil; modelin ve kıyafetin doğrudan içinde durduğu, derinlik hissi veren, gölgelerin zemine düştüğü, hacimsel ışıklandırmalı gerçek bir 3 boyutlu uzay/mekan (three-dimensional space with depth, realistic shadows cast on floor, volumetric lighting, parallax motion) olarak betimle.
- promptSuggestion Türkçe olmalı. Kıyafeti (türünü, rengini, giyim tipini, kumaşını, detaylarını), belirlenen arka planı/3D ortamı ve önerilen hareketi (motionId'ye uygun olarak mankenin yapacağı eylemleri, örn. yavaşça 360 derece dönerek kıyafeti sergilemesi, podyumda yürümesi veya rüzgarda dalgalanması) birleştiren doğal, akıcı ve profesyonel bir video tanıtım promptu olmalıdır. Kıyafetin hareket/akış durumunu, arka plan ortamını (sade stüdyo veya yukarıdaki kurala göre önerilen 3D mekanı) ve rüzgar esintisi gibi detayları doğrudan bu promptSuggestion içerisinde eylem ve sahne olarak betimle. Kumaşın kalın, tok ve tamamen opak/iç göstermez olduğunu da metin içinde belirt.
