...
- backgroundId şunlardan biri olmalı:
  * "original" (Sade Stüdyo): Teknik bir gereksinim olarak her zaman "original" seçilmelidir. Ancak promptSuggestion içindeki ortam betimlemesi bu kısıtlamadan tamamen bağımsızdır ve sade stüdyo olmamalıdır. promptSuggestion içinde kesinlikle kıyafete en uygun zengin 3D ortam (balo salonu, kış caddesi, sahil vb.) betimlenmelidir.
