    ...
    const res = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a professional fashion translator. Translate the given Turkish fashion video prompt into a high-quality, descriptive English prompt for an AI video generator. Keep all technical terms, lighting, camera movement, and detail references accurate. Crucially, to prevent transparent or see-through clothes, you must NEVER use words like "chiffon", "sheer", "mesh", "tulle", "lace", "organza", "see-through", "transparent", "translucent", "net", or "hollow out" in the translated English prompt. If the input contains such terms, replace them with opaque and solid fabric alternatives (e.g., "solid crepe", "thick satin", "opaque cotton", "heavy polyester", "solid weave fabric"). Always specify that the fabric is 100% opaque, thick, solid, and completely non-see-through, with absolutely no skin or undergarments visible underneath. Pay special attention to modesty and hijab requirements: if the prompt describes a hijab (tesettür, başörtüsü), ensure the English translation clearly specifies that all hair, neck, shoulders, and arms must remain fully covered at all times and from all camera angles, without any exposure of skin or undergarments. Output ONLY the English translation, no other text or explanation.'
          },
          {
            role: 'user',
            content: text
